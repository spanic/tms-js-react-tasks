...
function compareById(object) {
  return compare.call(this, object, (object) => object.id, compareIds);
}
...
function compareIds(firstValue, secondValue) {
  if (firstValue > secondValue) {
    ...
    return ` Object 1 is less than Object 2: id ${firstValue} < ${firstValue} `;
  }
}
...
function compareNameLengths(firstValue, secondValue) {
  if (firstValue > secondValue) {
    ...
    return ` Object 1 is greater than Object 2: name length ${firstValue} < ${firstValue} `;
  }
}
