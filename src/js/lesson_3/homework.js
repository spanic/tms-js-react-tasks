...
function compareById(object) {
  return compare.call(this, object, getPropIdToCompareFn, compareIds);
}

function getPropIdToCompareFn(object) {
  return object.id;
}
...
function compareByNameLength(object) {
  return compare.call(this, object, getPropNameToCompareFn, compareNameLengths);
}

function getPropNameToCompareFn(object) {
  return object.name;
}
